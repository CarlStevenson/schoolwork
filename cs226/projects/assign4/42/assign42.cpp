...
//   list class defined in listc.cpp. The interaction is menu-based.
// Flow of the program:
...
int main()
{
  ...
  // read in a file to pre-populate the list
  cout<<"Please enter the file you wish to pre-populate the list with:"<<endl;
  theList.readIn();
  // loop until exit
  while(go)
  {
    ...
    switch(choice)
    {
     ...
     // case 2 finds a user specified item in the list, if it contains it
      ...
      case 4:
              ...
              break;
      // case 5 reads in elements from a file
      case 5:
              cout<<"You chose menu item 5"<<endl;
              cout<<"Please enter the filename of the items you wish to import:"<<endl;
              theList.readIn();
              break;
      // case 6 displays the number of elements in the list
      case 6:
              cout<<"You chose menu item 6"<<endl;
              cout<<"There are "<<theList.numberOfElements()
                  <<" elements in the list.\n"<<endl;
              break;
      // case 7 exits my prompt loop and ends the program.
      case 7:
              cout<<"You chose menu item 7"<<endl;
              cout<<"Exiting now.\n"<<endl;
              go = false;
              list listCopy = theList;
