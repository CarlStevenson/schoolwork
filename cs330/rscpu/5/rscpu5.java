...
// 3/16/15
// rscpu5 adds add and sub instructions
// *************************************************************************
...
public class rscpu5
{
  ...
  public static void add()
  {
    ...
    // if AC goes from negative to positive, set the carry flag to 1
    if(AC + R == 0)
    {
      flag[0] = true;
    } else
    ...
    if(AC+R > 127 || AC + R < -128 || (AC < 0) && (AC+R >=0))
    {
      flag[1] = true;
    } else
    {
    ...
    // negative number."
    if(((AC > 0 && R>0) && AC+R>127) ||((AC < 0 && R <0) && AC+R >0))
    {
      flag[2] = true;
    } else
    {
  ...
  public static void sub()
  {
    ...
    // SUB1 subtracts R from AC, and sets the flags as appropriate
    ...
    // "the addition of two positive numbers results in a 
    // negative number."
    if(((AC > 0 && R<0) && AC+-R<0) ||((AC < 0 && R >0) && AC+-R >0))
    {
      flag[2] = true;
    } else
    {
